...
type SidebarGroupActionProps = React.ButtonHTMLAttributes<HTMLButtonElement> & { asChild?: boolean };
...
const SidebarMenuButton = React.forwardRef<HTMLElement, ComponentProps<"button"> & {
  asChild?: boolean
  isActive?: boolean
  ...
  ({
    ...
    // Destructure ref from props to avoid passing it via ...props
...
const SidebarMenuAction = React.forwardRef<HTMLElement, ComponentProps<"button"> & {
  asChild?: boolean
  showOnHover?: boolean
}>(
...
const SidebarMenuSubButton = React.forwardRef<HTMLElement, ComponentProps<"a"> & {
  asChild?: boolean
  size?: "sm" | "md"
  isActive?: boolean
}>(
